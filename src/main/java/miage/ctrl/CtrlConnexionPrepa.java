 ...
 * @author Ismail
 */
public class CtrlConnexionPrepa extends HttpServlet {
     ...
     */
     protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (p_s_email=="" && p_s_mdp==""){
            ...
            RequestDispatcher rd = request.getRequestDispatcher("ConnexionPrepa");
        ...
        //si mdp et email rempli.
                ...
                try {
                    ...
                    p_b_result = SeConnecter.verifierConnexionPrepa(p_s_email, p_s_mdp);
                    //si mdp et email valide.
                    if(p_b_result==true){
                        System.out.println("connecté avec succés");
                        Preparateur p_o_preparateur=SeConnecter.recupPreparateur(p_s_email, p_s_mdp);
                        System.out.println("Préparateur récupéré");
                    
                        //Création session.
                        HttpSession session = request.getSession(true);
                        session.setAttribute("preparateur", p_o_preparateur);
                        System.out.println("session créée");

                        //Rediriger vers la page articles
                        RequestDispatcher rd = request.getRequestDispatcher("CtrlListeCommandesPrepa");
                        rd.forward(request, response);
                ...
                RequestDispatcher rd = request.
                        getRequestDispatcher("ConnexionPrepa");
                rd.forward(request, response); 
                }
            }
        }
